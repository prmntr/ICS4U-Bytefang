...
public class Board {
    ...
    private void initializeBoard() {
        ...
        Character Bob = new Character("Bob", true, false, false, true, false, true, false, false, false, false, true, false, false, false);
        ...
        Character Zoe = new Character("Zoe", false, false, false, false, false, false, false, true, false, false, true, false, true, true);
        characterList.add(Zoe);
        Character Joe = new Character("Joe", true, true, true, false, true, false, false, false, false, false, false, false, false, false);
        characterList.add(Joe);
        Character Buba = new Character("Buba", false, false, false, false, false, false, true, false, false, true, true, false, false, false);
        characterList.add(Buba);
        Character Rita = new Character("Rita", false, false, false, false, false, false, true, false, false, true, true, false, false, false);
